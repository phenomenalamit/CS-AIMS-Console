...
@Component({
  selector: 'app-monitoring-revised',
  templateUrl: './monitoring-revised.component.html',
  styleUrls: ['./monitoring-revised.component.css'],
  providers: [
...
export class MonitoringRevisedComponent implements OnInit {
