...
@Component({
  selector: 'app-view-user-type-component',
  templateUrl: './view-user-type-component.component.html',
  styleUrls: ['./view-user-type-component.component.css']
})

export class ViewUserTypeComponentComponent implements OnInit {
  ...
  public ExportTOExcel(){
    ...
    this.excelService.exportTableElmToExcel("ExampleMaterialTable", 'User type');
